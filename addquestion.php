<?php
    ...
    if ($type == 0) {
        ...
        $insert = mysql_query("INSERT INTO jug264.ab_problem (qtype, question, a1, a2, a3, a4 , ca, subject, grade, qmodule) VALUES ('$type','$question', '$opt1', '$opt2', '$opt3', '$opt4', '$ca', '$subject', '$grade', '$module') ");
    }
    else {
        $question = mysql_real_escape_string($_POST['question']);
        $subject = mysql_real_escape_string($_POST['subject']);
        ...
        $insert = mysql_query("INSERT INTO jug264.ab_problem (qtype, question, subject, grade, qmodule) VALUES ('$type', '$question', '$subject', '$grade', '$module')");
