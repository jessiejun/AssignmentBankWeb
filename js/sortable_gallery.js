...
$(document).ready(function(){
    ...
    positionThumbnails();
    setInterval('checkViewpoint()',750);
...
function checkViewpoint(){
    ...
    /*debug*/ $('.debug-size').html('photoWidth = '+photoWidth+' thumbnailContainerWidth = '+thumbnailContainerWidth);
...
function positionThumbnails () {
    ...
    $('.thumbnail_container a.thumbnail.showMe').each(function(index) {
        var reminder = (index%max_C)/100;
        var maxIndex = 0;
        /* debug */ $('.debug-reminder').append(reminder + ' - ');
